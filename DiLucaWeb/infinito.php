...
<main>
    <div class="infinito" id="infinito">
        ...
        <div class="mb-5 container_padre">
            ...
            <div class="container">
                <div class="align-items-center justify-content-between row m-1">
                    <div class="align-items-center d-flex flex-column justify-content-center texto-container2 col-md-6" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000">
                    ...
                    <div class="col-md-6">
                        <div>
                            <div class="img-container align-items-end flex-column" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000">
                                <div class="back_titulo2 text-center">
                                    <p>INFINITO OPEN</p>
                                </div>
                                <img alt="" src="./assets/images/img/D8.webp" class="img_centro_infinito">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="veintidos" id="veintidos">
            ...
            <div class="container_padre">
                ...
                <div class="container flex-column-reverse">
                    <div class="flex-column-reverse flex-md-row justify-content-between m-5 row">
                        <div class="img-container col-md-5">
                            <img alt="" src="./assets/images/img/d36.webp" class="img-fluid mb-3" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000">
                            <img alt="" src="./assets/images/img/d37.webp" class="mb-5 img-fluid" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000">
                        </div>
                        <div class="mb-5 align-content-center col-md-6 text-center texto-container2" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000">
